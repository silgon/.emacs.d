...
Steel blue on black."
  ...
  (color-theme-install
   '(color-theme-comidia
     ...
     (font-lock-doc-string-face ((t (:foreground "tan3"))))
     (font-lock-function-name-face ((t (:foreground "LightSkyBlue"))))
     (font-lock-keyword-face ((t (:foreground "Cyan"))))
     (font-lock-preprocessor-face ((t (:foreground "Aquamarine"))))
     (font-lock-reference-face ((t (:foreground "LightSteelBlue"))))
     (font-lock-string-face ((t (:foreground "tan3"))))
     ...
     (message-separator-face ((t (:foreground "#282828"))))
     ...
     (primary-selection ((t (:background "#282828"))))
     ...
     (zmacs-region ((t (:background "#282828")))))))

(provide 'color-theme-mycomidia)
